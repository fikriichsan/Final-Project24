...
function Refleksi() {
    return (
      <div>
        ...
        <div>
          <div className="container">
            <div className="row">
              ...
              <div style={{marginTop:"-20px", display:"flex", justifyContent:"flex-end", marginLeft:"-50px"}} className="col-md-6">
        ...
        <div className="d-flex justify-content-start" style={{marginLeft:"100px"}}>
               <h2 style={{marginTop: "100px", fontWeight:"650"}}>Hasil Refleksi</h2>
        </div>
