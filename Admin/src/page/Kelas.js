          ...
          <div className="row justify-content-md-center">
            <div className="col-md-4">
              <Card
                content={{
                  ...
                  title: "Remedial",
                  Paragraph:
                    "Pembelajaran Konstektual Seni dan Budaya Berbasis Proyek."
                }}
              ></Card>
              <Link to="/module">
                <ButtonItem
            ...
            <div className="col-md-4">
              <Card
                content={{
                  imageUrl:
                    "https://images.unsplash.com/photo-1617791160588-241658c0f566?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1064&q=80",
                  title: "Presisi",
                  Paragraph:
